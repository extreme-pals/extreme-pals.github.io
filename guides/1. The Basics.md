...
If you're still wondering what forks and clones have in common - they both have special meanings in version control that might be rather unintuitive, as you've just seen :)
...
And finally, type `git push`. It will most likely ask you for your GitHub username and password, after which, Git will do its magic and your changes will be up online.

The rest of your teammates will now have to run `git pull` to get those changes on their computers, so let them know if you've pushed some!
