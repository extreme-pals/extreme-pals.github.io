...
Some things that you might want to implement with your teammates in increasing difficulty could be:
...
* A game menu, to appear when you start the game or when the game is paused
